...
|html/iidx_1p_color.html|650×370|IIDX 1P側、リリースタイム色分け表示|
|html/iidx_2p_color.html|650×370|IIDX 2P側、リリースタイム色分け表示|
|html/iidx_dp_color.html|1300×370|IIDX DP、リリースタイム色分け表示|
