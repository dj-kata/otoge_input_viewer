...
メニューバーの`key config`からキーコンフィグを手動で行うこともできます。  
PHOENIX WANやFAUCE TWOではこの設定は不要ですが、  
1鍵を押しているのに2鍵が光る、みたいなデバイスをお使いの方は手動登録をお試しください。
<img width="631" alt="image" src="https://github.com/user-attachments/assets/3b639484-8862-449e-a990-55ceabcbf173" />
...
複数のコントローラを同時に扱う都合でDPモードが色々と複雑になっており、
